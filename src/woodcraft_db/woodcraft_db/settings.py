"""
Django settings for woodcraft_db project.
...
CORS_ALLOWED_ORIGINS = [
    ...
    "https://woodcraft-backend.onrender.com",
]
...
WSGI_APPLICATION = 'woodcraft_db.wsgi.application'


# Database
# https://docs.djangoproject.com/en/5.1/ref/settings/#databases

# SQLite database settings (for local development)
# DATABASES = {
#     'default': {
